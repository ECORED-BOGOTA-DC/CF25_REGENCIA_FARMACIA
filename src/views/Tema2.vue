...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-5(data-aos="fade-right") En este apartado se presentan los estándares en los procesos de selección y adquisición de medicamentos y dispositivos médicos, a saber, habilitación, selección y adquisición de medicamentos y dispositivos médicos, control de documentos y registros e indicadores de gestión.
    ...
    p.mb-5 Los estándares de calidad para medir los procesos de selección y adquisición de medicamentos y dispositivos médicos están regidos por el Decreto 780 del 2016 y la Resolución 1403 del 2007, por lo que la forma de dar cumplimiento total a la normatividad es realizar auditorías internas y autoevaluaciones de verificación y control a la luz de esta para detectar a tiempo cualquier irregularidad que se pueda estar presentando.
    ...
    p.mb-5(data-aos="fade-left") En cuanto al archivo también se debe concretar por necesidad y complejidad el tiempo que se tendrán los documentos archivados, la mayor parte de estos se dejan máximo dos años, pero puede haber algunos que sea necesario tenerlos a disposición hasta por 20 años.
    ...
    AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta-morada" data-aos="zoom-in")
      .row.justify-content-center.p-4(titulo="Objetivos de los indicadores de los procesos de selección y adquisición")
      ...
      .row.justify-content-center.p-4(titulo="Indicadores del proceso de adquisición de medicamentos y dispositivos médicos")
        .col-lg-8.order-lg-1.order-2
